...
export default function Step3Attachments({ form }: Step3AttachmentsProps) {
  ...
  return (
    <div>
      ...
      <Form.Item
        ...
        name="attachments"
        tooltip="Upload các file liên quan đến hoạt động (kế hoạch, quyết định, hình ảnh...)"
      >
        <div>
          <Upload
